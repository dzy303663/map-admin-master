        ...
        <el-col :span="8">
          <el-form ref="form" :model="form" :rules="rules" label-width="100px">
            ...
            <el-form-item label="公告内容:" prop="content">
              <quill-editor id="QE" v-model="form.content" :options="editorOption"></quill-editor>
            </el-form-item>
            <el-form-item>
...
export default {
  ...
  methods: {
    ...
    get_form_data() {
      this.load_data = true;
      axios
        .get("/api/department/announcement/detail", {
          params: {
            id: this.route_id
          }
        })
    ...
    on_submit_form() {
      this.$refs.form.validate(valid => {
        ...
        let url = this.route_id
          ? "/api/department/announcement/update"
          : "/api/department/announcement/add";
        axios
          .post(url, {
            ...this.form,
            type: '系公告',
